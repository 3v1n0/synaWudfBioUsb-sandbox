...
x86_64-w64-mingw32-g++ -Wl,--stack,32000000 -g3 -I./wdk-10/Include/wdf/umdf/1.11 -I. -Wall hello.cc breakpoints.c -luuid -lole32 -L. -lpropsys -lsetupapi -lwinusb -lcfgmgr32 -lrpcrt4 -o b.exe
